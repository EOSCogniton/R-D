...
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tyre_model_v3_msf.mexw64
...
MODELREF_LINK_RSPFILE     = tyre_model_v3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tyre_model_v3_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/tyre_model_v3/tyre_model_v3_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = tyre_model_v3_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/marti/DOCUME~1/EPSA/GIT/R-D/COMMAN~1/2025-M~1/POSTST~1/OPTIMI~1/CARMOD~1/slprj/sim/TYRE_M~1/TYRE_M~1.LIB
...
tyre_model_v3_msf.obj : $(START_DIR)/slprj/sim/tyre_model_v3/tyre_model_v3_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"

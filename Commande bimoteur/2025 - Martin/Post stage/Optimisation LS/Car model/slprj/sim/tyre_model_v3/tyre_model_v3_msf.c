...
#define S_FUNCTION_NAME tyre_model_v3_msf
#endif
...
real_T rtP_J ; real_T rtP_Re ; real_T rtP_v0 ; const char *
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_J ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_Re ) , GlobalPrm_1 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP_v0 ) , GlobalPrm_2 , sizeof ( real_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * ) ssGetContStates ( S ) ; ctj0dr1dia ( & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } static void mdlReset ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * ) ssGetContStates ( S ) ; b33kdovnog ( & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; real_T const * i_m3h15dk5ue = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_a2lyk3rizc = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_d3ovegl1h3 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_psw3yfnwfw = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_m4yocsnhsx = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_ng3gimn0k0 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_c4dh0kk2vg = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T * o_B_9_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_9_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_9_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_9_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * ) ssGetContStates ( S ) ; if ( tid == 0 ) { tyre_model_v3 ( & ( dw -> rtm ) , i_m3h15dk5ue , i_a2lyk3rizc , i_d3ovegl1h3 , i_psw3yfnwfw , i_m4yocsnhsx , i_ng3gimn0k0 , i_c4dh0kk2vg , o_B_9_1 , o_B_9_2 , o_B_9_3 , o_B_9_4 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; jj2kuw0p0x ( & ( dw -> rtm ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 7 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 7 , 4 ) ; if ( ! ssSetNumInputPorts ( S , 7 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "Pa" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 0 , unitIdReg ) ;
#endif
...
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "N" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 6 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "N" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 1 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "N" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 2 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "1" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 3 , unitIdReg ) ;
#endif
...
mr_tyre_model_v3_MdlInfoRegFcn ( S , "tyre_model_v3" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( mpynaegtodz ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * ) ssGetContStates ( S ) ; ssNonContDerivSigFeedingOutports mr_nonContOutput0 [ 2 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput3 [ 2 ] ; ssNonContDerivSigFeedingOutports * mr_nonContOutputArray [ 4 ] ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } mr_nonContOutputArray [ 0 ] = mr_nonContOutput0 ; mr_nonContOutputArray [ 1 ] = ( NULL ) ; mr_nonContOutputArray [ 2 ] = ( NULL ) ; mr_nonContOutputArray [ 3 ] = mr_nonContOutput3 ; c32f4zxe52 ( S , mr_nonContOutputArray , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 0 , mr_nonContOutput0 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 3 , mr_nonContOutput3 ) ) return ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; md0tlitb5s ( & ( dw ->
rtb ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; real_T const *
i_m3h15dk5ue = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_a2lyk3rizc = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_d3ovegl1h3 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_psw3yfnwfw = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const *
i_m4yocsnhsx = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_ng3gimn0k0 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const *
i_c4dh0kk2vg = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T * o_B_9_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_9_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_9_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_9_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * )
ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) {
tyre_model_v3TID2 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ||
ssIsMinorTimeStep ( S ) ) { tyre_model_v3 ( & ( dw -> rtm ) , i_m3h15dk5ue ,
i_a2lyk3rizc , i_d3ovegl1h3 , i_psw3yfnwfw , i_m4yocsnhsx , i_ng3gimn0k0 ,
i_c4dh0kk2vg , o_B_9_1 , o_B_9_2 , o_B_9_3 , o_B_9_4 , & ( dw -> rtb ) , & ( dw
-> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { mpynaegtodz * dw = ( mpynaegtodz * ) ssGetDWork ( S , 0 ) ; jj2kuw0p0x ( & ( dw -> rtm ) ) ; return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz
* ) ssGetDWork ( S , 0 ) ; e3e2pluf2v * localX = ( e3e2pluf2v * )
ssGetContStates ( S ) ; cwovm3tzto * localXdot = ( cwovm3tzto * ) ssGetdX ( S
) ; mu3r0ofjgl ( & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , localXdot ) ;
} static void mdlTerminate ( SimStruct * S ) { mpynaegtodz * dw = ( mpynaegtodz
* ) ssGetDWork ( S , 0 ) ; bpwqvb04id ( & ( dw -> rtm ) ) ; return ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const e3e2pluf2v
* localX = ( const e3e2pluf2v * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( e3e2pluf2v ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_tyre_model_v3_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss
, 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_tyre_model_v3_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss ,
...
e3e2pluf2v * localX = ( e3e2pluf2v * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( e3e2pluf2v ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_tyre_model_v3_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss

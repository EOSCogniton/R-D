...
#define S_FUNCTION_NAME charges_pneus_msf
#endif
...
real_T rtP_L ; real_T rtP_fr ; real_T rtP_g ; real_T rtP_h ; real_T rtP_m ;
real_T rtP_t ; const char * rt_GetMatSignalLoggingFileName ( void ) { return
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; real_T * GlobalPrm_3 = ( real_T * ) NULL ; real_T * GlobalPrm_4 = ( real_T * ) NULL ; real_T * GlobalPrm_5 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_L ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_fr ) , GlobalPrm_1 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP_g ) , GlobalPrm_2 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP_h ) , GlobalPrm_3 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * * ) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy ( & ( rtP_m ) , GlobalPrm_4 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void ) memcpy ( & ( rtP_t ) , GlobalPrm_5 , sizeof ( real_T ) ) ; } }
#endif
static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
hh3lbtsamd0 * dw = ( hh3lbtsamd0 * ) ssGetDWork ( S , 0 ) ; real_T const *
i_oxembnrz3b = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_accshafvgg = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_ecocsgvxz4 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
charges_pneus ( i_oxembnrz3b , i_accshafvgg , i_ecocsgvxz4 , o_B_1_1 , & ( dw
-> rtb ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S
...
mr_charges_pneus_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2
...
mr_charges_pneus_MdlInfoRegFcn ( S , "charges_pneus" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( hh3lbtsamd0 ) ) )
...
mdlInitializeSampleTimes ( SimStruct * S ) { ssSetSampleTime ( S , 0 , 0.001
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { hh3lbtsamd0 * dw = ( hh3lbtsamd0 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } ljbzawgrsu ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { hh3lbtsamd0 * dw = ( hh3lbtsamd0 * ) ssGetDWork ( S , 0 ) ; real_T const * i_oxembnrz3b = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_accshafvgg = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_ecocsgvxz4 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == PARAMETER_TUNING_TID ) { charges_pneusTID1 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { charges_pneus ( i_oxembnrz3b , i_accshafvgg , i_ecocsgvxz4 , o_B_1_1 , & ( dw -> rtb ) ) ; } } static void mdlTerminate ( SimStruct * S ) { hh3lbtsamd0 * dw = ( hh3lbtsamd0 * ) ssGetDWork ( S , 0 ) ; eskogmxsu3 ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_charges_pneus_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_charges_pneus_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss ,
...
mr_charges_pneus_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss ,

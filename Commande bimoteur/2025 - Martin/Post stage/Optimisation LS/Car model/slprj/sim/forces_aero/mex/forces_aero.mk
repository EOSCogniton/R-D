...
## Generated on : Sat Jun 27 23:34:23 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/forces_aero_msf.mexw64
...
MODELREF_LINK_RSPFILE     = forces_aero_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/forces_aero_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/forces_aero/forces_aero_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = forces_aero_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/marti/DOCUME~1/EPSA/GIT/R-D/COMMAN~1/2025-M~1/POSTST~1/OPTIMI~1/CARMOD~1/slprj/sim/FORCES~1/FORCES~1.LIB
...
forces_aero_msf.obj : $(START_DIR)/slprj/sim/forces_aero/forces_aero_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"

###########################################################################
## Makefile generated for component 'arduino_setup'. 
## 
## Makefile     : arduino_setup.mk
## Generated on : Wed Oct 15 12:43:24 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_setup.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_setup.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=10 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=18750 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=2 -DARDUINO_SERIAL_RECEIVE_BUFFER_SIZE=256 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -DMW_NUM_PINS=20 -D_ONBOARD_EEPROM_SIZE_=0
...
DEFINES_STANDARD = -DMODEL=arduino_setup -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_SerialRead.o MW_SerialWrite.o arduino_setup.o MW_ArduinoHWInit.o io_wrappers.o mw_samd_nvic.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/arduino_setup_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_setup_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_setup_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/arduino_setup_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_setup_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_setup.o : $(START_DIR)/arduino_setup_ert_rtw/arduino_setup.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_setup_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"

...
v0=0.001; %vitesse initiale pour la simulation
...
epsilon=0.001; %pour éviter les divisions par 0 dans le calcul du SR
K_p=4444; %gain proportionnel du TC
K_I=0; %gain intégral du TC
